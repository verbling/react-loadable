      ...
      ImportDeclaration: function ImportDeclaration(path, state) {
        ...
        binding.referencePaths.forEach(function (refPath) {
          ...
          propertiesMap.loader.insertAfter(t.objectProperty(t.identifier('modules'), t.arrayExpression(dynamicImports.map(function (dynamicImport) {
            var relativePath = dynamicImport.get('arguments')[0].node.value;
            var absolutePath = (0, _path.resolve)((0, _path.dirname)(state.filename), relativePath);

            return t.stringLiteral((0, _md2.default)(absolutePath));
          }))));
        });
      }
    }
